function repeat(){
  ...
  request.onreadystatechange = function(){
    if (this.readyState == 4 && this.status == 200) { //pokud ma pripojeni - spusti se kod
      ...
      document.getElementById("temperatureID").innerHTML = (work.main.temp).toFixed(1)  + "°C";
      document.getElementById("windID").innerHTML = (work.wind.speed).toFixed(1)  + 'm/s';
...
function repeatDaily(){
  ...
  daily.onreadystatechange = function(){
    if (this.readyState == 4 && this.status == 200) { //pokud ma pripojeni - spusti se kod
      ...
      document.getElementById("tempID1").innerHTML = (work.list[1].main.temp).toFixed(1) + "°C";
      document.getElementById("windID1").innerHTML = (work.list[1].wind.speed).toFixed(1) + 'm/s';
      ...
      document.getElementById("tempID2").innerHTML = (work.list[2].main.temp).toFixed(1) + "°C";
      document.getElementById("windID2").innerHTML = (work.list[2].wind.speed).toFixed(1) + 'm/s';
      ...
      document.getElementById("tempID3").innerHTML = (work.list[8].main.temp).toFixed(1) + "°C";
      document.getElementById("windID3").innerHTML = (work.list[8].wind.speed).toFixed(1) + 'm/s';
      ...
      document.getElementById("tempID4").innerHTML = (work.list[16].main.temp).toFixed(1) + "°C";
      document.getElementById("windID4").innerHTML = (work.list[16].wind.speed).toFixed(1) + 'm/s';
      ...
      document.getElementById("tempID5").innerHTML = (work.list[24].main.temp).toFixed(1) + "°C";
      document.getElementById("windID5").innerHTML = (work.list[24].wind.speed).toFixed(1) + 'm/s';
